class Admin::PortfolioFiisController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @portfolio_fii.save
        format.html { redirect_to admin_portfolio_fiis_url, notice: 'Portfolio fii was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @portfolio_fii.update(portfolio_fii_params)
        format.html { redirect_to admin_portfolio_fiis_url, notice: 'Portfolio fii was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_portfolio_fiis_url, notice: 'Portfolio fii was successfully destroyed.' }
