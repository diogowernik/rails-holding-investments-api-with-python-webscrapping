class Admin::SituationsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @situation.save
        format.html { redirect_to admin_situations_url, notice: 'Situation was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @situation.update(situation_params)
        format.html { redirect_to admin_situations_url, notice: 'Situation was successfully updated.' }
  ...
  def destroy
    @situation.destroy
    respond_to do |format|
      format.html { redirect_to admin_situations_url, notice: 'Situation was successfully destroyed.' }
  ...
  private
    ...
    def situation_params
      params.require(:situation).permit(:title, :slug)
    end
end
