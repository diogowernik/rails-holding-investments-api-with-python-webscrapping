class Admin::PortfolioBrStocksController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @portfolio_br_stock.save
        format.html { redirect_to admin_portfolio_br_stocks_url, notice: 'Portfolio br stock was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @portfolio_br_stock.update(portfolio_br_stock_params)
        format.html { redirect_to admin_portfolio_br_stocks_url, notice: 'Portfolio br stock was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_portfolio_br_stocks_url, notice: 'Portfolio br stock was successfully destroyed.' }
