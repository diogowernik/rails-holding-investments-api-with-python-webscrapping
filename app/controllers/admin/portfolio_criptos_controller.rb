class Admin::PortfolioCriptosController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @portfolio_cripto.save
        format.html { redirect_to admin_portfolio_criptos_url, notice: 'Portfolio cripto was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @portfolio_cripto.update(portfolio_cripto_params)
        format.html { redirect_to admin_portfolio_criptos_url, notice: 'Portfolio cripto was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to admin_portfolio_criptos_url, notice: 'Portfolio cripto was successfully destroyed.' }
