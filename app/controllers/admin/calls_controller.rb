class Admin::CallsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @call.save
        format.html { redirect_to admin_calls_url, notice: 'Call was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @call.update(call_params)
        format.html { redirect_to admin_calls_url, notice: 'Call was successfully updated.' }
