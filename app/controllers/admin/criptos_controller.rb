class Admin::CriptosController < AdminController
    ...
    def create
      ...
      respond_to do |format|
        if @cripto.save
          format.html { redirect_to admin_criptos_url, notice: 'Cripto was successfully created.' }
    ...
    def update
      respond_to do |format|
        if @cripto.update(cripto_params)
          format.html { redirect_to admin_criptos_url, notice: 'Cripto was successfully updated.' }
    ...
    def destroy
      @cripto.destroy
      respond_to do |format|
        format.html { redirect_to admin_criptos_url, notice: 'Cripto was successfully destroyed.' }
