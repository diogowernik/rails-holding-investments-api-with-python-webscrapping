class FiisController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @fii.save
        format.html { redirect_to @fii, notice: 'Fii was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @fii.update(fii_params)
        format.html { redirect_to @fii, notice: 'Fii was successfully updated.' }
  ...
  def destroy
    @fii.destroy
    respond_to do |format|
      format.html { redirect_to fiis_url, notice: 'Fii was successfully destroyed.' }
