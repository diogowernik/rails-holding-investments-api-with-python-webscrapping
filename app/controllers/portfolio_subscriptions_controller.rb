class PortfolioSubscriptionsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @portfolio_subscription.save
        format.html { redirect_to portfolio_subscriptions_management_path(@portfolio_subscription.portfolio.id), notice: 'Portfolio subscription was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @portfolio_subscription.update(portfolio_subscription_params)
        format.html { redirect_to portfolio_subscriptions_management_path(@portfolio_subscription.portfolio.id), notice: 'Portfolio subscription was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to portfolio_subscriptions_management_path(@portfolio_subscription.portfolio.id), notice: 'Portfolio subscription was successfully destroyed.' }
